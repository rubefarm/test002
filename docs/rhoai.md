...
2) Go to the `Data Science Projects` section and access your application's project named `rhdh-app-test002`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `test002-notebook`.
...
5) In the terminal, run `cd test002` to navigate to your sample app's directory.
